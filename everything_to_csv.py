...
OUTPUT = "all_the_data.csv"
GENRES = ['hip hop', 'r&b', 'folk', 'metal', 'reggae', 'rock', 'electronic', 'pop', 'jazz', 'country']
...
for h5filename in allh5:
    ...
    with hdf5_getters.open_h5_file_read(h5filename) as h5:
        ...
        song_year = hdf5_getters.get_year(h5)
        song_duration = hdf5_getters.get_duration(h5)
        song_tempo = hdf5_getters.get_tempo(h5)
        ...
        row = [song_genre] + [song_year] + [song_duration] + [song_tempo] + row
