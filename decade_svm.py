...
DATA_FILE = "data/DecadePredictionMSD.txt"
OUTPUT_FILE = "decade_confusion.csv"
DELIM = ","
...
classifier = linear_model.SGDClassifier(loss="hinge") # hinge for unbalanced data
...
conf_mtx = confusion_matrix(y_true, y_predict, labels=np.arange(DATE_START, DATE_END, 10))
